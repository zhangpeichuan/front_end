...
//非H5富文本转义
		export const HTMLEncode = (str) => {
				...
				}).replace('<section', '<div').replace('<img', '<img style="max-width:100%;height:auto" ').replace(/<p><img/g,'<div><img').replace(/<p/g,'<p style="padding:0 10px" ');
			}
//H5富文本转义
export const HTMLEncode_h5 = (text) => {
